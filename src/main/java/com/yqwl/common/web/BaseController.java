...
public abstract class BaseController {
	...
	protected String dealSuccessResult(String msg,Object result){
		return FastJsonUtil.getResponseJson(0, msg, result);
	}
    protected String dealFaidResult(String msg,Object result){
        return FastJsonUtil.getResponseJson(-1, msg, result);
    }
}
